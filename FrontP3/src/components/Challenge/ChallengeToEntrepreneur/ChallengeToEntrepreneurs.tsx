        ...
        <>
          ...
          >
            <div style={{ width: '100%', maxWidth: 700, minHeight: 300 }}>
                        ...
                        <Text style={{ color: '#ccc' }}>
                          ...
                          <div style={{ display: 'flex', alignItems: 'center', gap: 10, color: '#69b1ff' }}>
                            ...
                            <Tooltip title="Ver Empresa">
                              <div onClick={() => openModal(challenge.empresaId)} style={{ cursor: 'pointer' }}>
              ...
              <div
                style={{ display: 'flex', justifyContent: 'center', flexWrap: 'wrap', gap: '12px', marginTop: '16px' }}
              >
            ...
            {/* MODAL DETALLES */}
            {selectedCompany && (
              <CompanyModal open={isModalOpen} onClose={() => setIsModalOpen(false)} _id={selectedCompany._id} />
            )}
          </div>
        </>
      )}
