  ...
  return (
    <Modal
      ...
      styles={{
        ...
        content: { background: "#0d1117", borderRadius: "12px", border: "1px solid #1677ff", boxShadow: "0 0 12px rgba(22, 119, 255, 0.4)" }
      }}
    >
      {company && (
        <>
          ...
          <p style={{ color: "#69b1ff" }}> <PhoneOutlined /> {company.telefono}</p>
          <h3
