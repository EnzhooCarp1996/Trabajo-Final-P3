...
interface ProposalFormProps {
  ...
  formSubmit: () => void
  editing?: boolean
  form: FormInstance<CreateProposalRequest>;
  handleSubmit: (values: CreateProposalRequest) => void
}
...
export const ProposalForm: React.FC<ProposalFormProps> = ({
  ...
  return (
    <ModalGeneral titulo={titulo} isOpen={isModalOpen} onClose={closeModal} onOk={formSubmit} editing={editing}>
      <FormGeneral form={form} handleSubmit={handleSubmit}>
        <Title level={3} style={{ color: '#69b1ff' }}>
