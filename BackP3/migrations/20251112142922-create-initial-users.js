  ...
  const initialUsers = [
    {
      ...
      descripcion: 'Emprendedor enfocado en el desarrollo de soluciones digitales y plataformas web innovadoras.',
      telefono: '1111111111',
      activo: true,
      createdAt: new Date(),
      updatedAt: new Date(),
    ...
    },
    {
      ...
      descripcion: 'Emprendedor joven interesado en proyectos tecnológicos con impacto social.',
      edad: 25,
      telefono: '3333333333',
      activo: true,
      createdAt: new Date(),
    ...
    },
    {
      ...
      descripcion: 'Emprendedora creativa con experiencia en gestión de proyectos y diseño digital.',
      edad: 29,
      telefono: '4444444444',
      activo: true,
      createdAt: new Date(),
    ...
    },
    {
      ...
      descripcion: 'Emprendedor especializado en análisis de datos y automatización de procesos.',
      edad: 32,
      telefono: '5555555555',
      activo: true,
      createdAt: new Date(),
    ...
    },
    {
      ...
      descripcion: 'Emprendedora enfocada en innovación, marketing digital y nuevas tecnologías.',
      edad: 27,
      telefono: '8888888888',
      activo: true,
      createdAt: new Date(),
    ...
    },
    {
      ...
      descripcion: 'Emprendedor con interés en desarrollo full stack y soluciones escalables.',
      edad: 30,
      telefono: '9999999999',
      activo: true,
      createdAt: new Date(),
    ...
    },
    {
      ...
      descripcion: 'Emprendedora en formación apasionada por startups y economía digital.',
      edad: 24,
      telefono: '1313131313',
      activo: true,
      createdAt: new Date(),
    ...
    },
    {
      ...
      descripcion: 'Emprendedor con experiencia en liderazgo de equipos y desarrollo de negocios.',
      edad: 35,
      telefono: '1414141414',
      activo: true,
      createdAt: new Date(),
